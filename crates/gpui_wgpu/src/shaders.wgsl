...
// --- surface RGBA --- //
// Draws an external RGBA texture registered via the surface texture pool.
// The bind group layout differs from the YCbCr surface pipeline: a single
// RGBA texture + sampler instead of separate Y and CbCr planes.
